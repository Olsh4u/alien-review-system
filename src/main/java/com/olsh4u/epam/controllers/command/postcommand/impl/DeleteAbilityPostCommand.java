...
/**
 * Command to delete {@link com.olsh4u.epam.models.Ability}.
 *
 * @see Command
 * @see com.olsh4u.epam.controllers.command.postcommand.PostCommandProvider
 */
public class DeleteAbilityPostCommand implements Command {
    ...
    public CommandResponse execute(final HttpServletRequest req,
        ...
        try {
            ServiceFactory.getInstance().getAbilityService().delete(id);
