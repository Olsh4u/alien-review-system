...
public class IndexGetCommand implements Command {
    ...
    public CommandResponse execute(final HttpServletRequest req,
        ...
        try {
            ...
            List<Alien> alienList = ServiceFactory.getInstance().getAlienService().findAlienPageByPage(page, COUNT_ALIEN_IN_MAIN_PAGE);
            ...
            req.setAttribute(PARAMETER_ITEM_ON_PAGE, COUNT_ALIENS_IN_MAIN_PAGE);
