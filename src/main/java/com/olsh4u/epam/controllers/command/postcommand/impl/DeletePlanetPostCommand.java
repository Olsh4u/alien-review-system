...
/**
 * Command to delete {@link com.olsh4u.epam.models.Planet}.
 *
 * @see Command
 * @see com.olsh4u.epam.controllers.command.postcommand.PostCommandProvider
 */
public class DeletePlanetPostCommand implements Command {
    ...
    public CommandResponse execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ServiceFactory.getInstance().getPlanetService().delete(id);
            return new CommandResponse(RoutingType.REDIRECT, ROUTING_PLANET_PAGE, req, resp);
