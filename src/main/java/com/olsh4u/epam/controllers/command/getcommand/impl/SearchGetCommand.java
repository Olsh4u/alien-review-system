...
public class SearchGetCommand implements Command {
    ...
    public CommandResponse execute(final HttpServletRequest req,
        ...
        try {
            ...
            SearchForm searchForm = new SearchForm(req.getParameter(PARAMETER_QUERY), req.getParameterValues(PARAMETER_SOURCES),
                    req.getParameterValues(PARAMETER_ABILITY), req.getParameterValues(PARAMETER_PLANET));

            int countAllAliens = ServiceFactory.getInstance().getAlienService().countAllAliensBySearchForm(searchForm);
            List<Alien> alienList = ServiceFactory.getInstance()
                    .getAlienService().findAlienBySearchForm(searchForm, page, COUNT_ALIEN_IN_SEARCH_PAGE);
            ...
            req.setAttribute(PARAMETER_ITEM_ON_PAGE, COUNT_ALIEN_IN_SEARCH_PAGE);
