...
(
    ...
    CONSTRAINT fk_alien_source FOREIGN KEY (source_id)
        ...
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT fk_alien_author FOREIGN KEY (author_id)
...
CREATE TABLE alien_superpower
(
    alien_id  INTEGER NOT NULL,
    superpower_id INTEGER NOT NULL,
    UNIQUE (alien_id, superpower_id),
    CONSTRAINT fk_alien_superpower_alien FOREIGN KEY (alien_id)
        REFERENCES aliens (id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT fk_alien_superpower_superpower FOREIGN KEY (superpower_id)
